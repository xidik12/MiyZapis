        ...
        <div className="px-4 py-3 space-y-3">
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-2">
                {[
                  { icon: <Calendar size={18} />, label: s('bookings'), path: userRole === 'specialist' ? '/specialist-bookings' : '/bookings', color: 'text-accent-primary' },
                  ...
                  { icon: <Star size={18} />, label: s('reviews'), path: userRole === 'specialist' ? '/specialist/reviews' : '/reviews', color: 'text-accent-yellow' },
            ...
            {userRole === 'specialist' && (
              <div>
                ...
                <div className="grid grid-cols-4 gap-2">
                  {[
                    { icon: <Briefcase size={18} />, label: s('specServices'), path: '/specialist-services', color: 'text-accent-primary' },
