 ...
 * Specialist referral program with analytics and sharing
 */
    ...
    <View style={styles.heroContainer}>
      ...
      >
        ...
        <View style={styles.heroContent}>
          ...
          <Text style={styles.heroSubtitle}>{t('referrals.subtitle')}</Text>
        </View>
      </LinearGradient>
    </View>
  );
          ...
          <View style={styles.codeActions}>
            <Button
              ...
              onPress={() => {
                ...
                Share.share({
                  message: `${t('referrals.shareMessage')} ${config.referralCode}\n${referralLink}`,
