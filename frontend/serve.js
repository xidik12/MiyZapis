...
app.use((_req, res, next) => {
  ...
  // camera=(self): the POS barcode scanner needs getUserMedia on our own origin.
  // An empty camera=() allowlist disables the camera for EVERYONE on EVERY device
  // (getUserMedia → NotAllowedError) regardless of the user's browser/OS grant.
