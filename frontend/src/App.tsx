...
import { useCapacitorShell, registerPush } from './lib/capacitor';
...
const SpecialistPOS = React.lazy(() => import('./pages/specialist/POS'));
const SpecialistTeam = React.lazy(() => import('./pages/specialist/Team'));
...
const usePageTitle = () => {
  ...
  useEffect(() => {
    const titles: Record<string, string> = {
      ...
      '/specialist/pos': 'Point of Sale - МійЗапис',
      '/specialist/team': 'Team - МійЗапис',
...
function App() {
  ...
  // Native push often registers before login at cold start (token POST fails,
  // swallowed). Re-register once the user is authenticated so the token lands.
  useEffect(() => {
