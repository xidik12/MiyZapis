    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200/20 dark:border-gray-700/20">
          ...
          >
            <div className="w-10 h-10 bg-primary-600 text-white rounded-lg flex items-center justify-center text-base font-bold group-hover:scale-110 transition-all duration-300">
              P
            </div>
