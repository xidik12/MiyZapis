  ...
  return (
    ...
    >
      <div className="flex items-center justify-between h-16 px-4">
        ...
        >
          <div className="w-8 h-8 rounded-xl bg-huddle-gradient text-white flex items-center justify-center text-sm font-bold shadow-primary group-hover:shadow-lg group-hover:-translate-y-0.5 transition-all duration-300">
            H
          </div>
