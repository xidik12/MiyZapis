          ...
          {booking.status === 'CONFIRMED' && booking.service?.serviceLocation && (
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-3 sm:p-4">
              ...
              <div className="space-y-2 text-xs sm:text-sm">
                ...
                {/* Google Maps Link */}
                {(booking.service as any).latitude && (booking.service as any).longitude && (
                  <div className="mt-3">
                    <a
                      href={`https://www.google.com/maps?q=${(booking.service as any).latitude},${(booking.service as any).longitude}`}
                      target="_blank"
                    ...
                    >
                      <MapPinIcon className="w-4 h-4 mr-2" />
                      {t('bookings.openInGoogleMaps') || 'Open in Google Maps'}
                    </a>
                  </div>
                )}
