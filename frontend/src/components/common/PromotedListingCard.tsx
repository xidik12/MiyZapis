      ...
      <div className="p-3 sm:p-4">
        ...
        <div className="mt-3 flex gap-3">
          ...
          <div className="min-w-0 flex-1 flex flex-col">
            ...
            >
              {/* Honor the advertiser's custom button text when set; otherwise fall
                  back to the translated CTA so it follows the viewer's language. */}
              {item.ctaLabel?.trim() || t('promote.bookCta') || t('common.book') || 'Book'}
            </Link>
          </div>
        </div>
      </div>
