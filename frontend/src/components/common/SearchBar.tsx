    ...
    <form onSubmit={handleSubmit} className={`relative ${className}`}>
      <div className="relative">
        <input
          ...
          className="w-full pl-10 pr-4 py-3 sm:py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent hover:border-primary-300 dark:hover:border-primary-500 hover:shadow-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 text-base sm:text-sm transition-all duration-200"
        />
