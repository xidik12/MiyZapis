  ...
  return (
    ...
    >
      <div
        onClick={onClick}
        className={`
          px-4 py-3.5 cursor-pointer transition duration-200 active:scale-[0.96]
        ...
        <div className="flex-shrink-0 flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
          {notification.actionUrl && (
            <button
              ...
              className="w-10 h-10 flex items-center justify-center rounded-xl hover:bg-blue-100/80 dark:hover:bg-blue-900/30 text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition duration-200 hover:scale-110 active:scale-[0.96]"
          ...
          {!notification.isRead && (
            <button
              ...
              className="w-10 h-10 flex items-center justify-center rounded-xl hover:bg-green-100/80 dark:hover:bg-green-900/30 text-gray-500 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 transition duration-200 hover:scale-110 active:scale-[0.96]"
          ...
          <button
            onClick={onDelete}
            className="w-10 h-10 flex items-center justify-center rounded-xl hover:bg-red-100/80 dark:hover:bg-red-900/30 text-gray-500 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 transition duration-200 hover:scale-110 active:scale-[0.96]"
