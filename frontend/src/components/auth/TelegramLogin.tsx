    ...
    <div className="w-full">
      ...
      {!widgetReady && (
        <a
          ...
          className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-[#54a9eb] hover:bg-[#4a96d2] text-white font-semibold rounded-xl transition duration-200 shadow-sm active:scale-[0.96]"
        >
