...
const ReviewCardComponent: React.FC<ReviewCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:border-gray-300 dark:hover:border-gray-700 transition-all duration-200 overflow-hidden border border-gray-100 dark:border-gray-700"
    >
      {/* Header Section */}
