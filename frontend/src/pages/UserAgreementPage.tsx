    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          'Circumventing platform fees by arranging bookings discovered on MiyZapis through external channels to avoid the subscription or per-booking fee ("fee circumvention").',
        ...
        subsections: [
          {
            ...
            items: [
              ...
              'Pay-per-booking alternative: Specialists who do not hold an active subscription are charged ₴20 per confirmed booking processed through the platform.',
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          'Обхід платформових комісій шляхом домовленостей із спеціалістами, знайденими на MiyZapis, через зовнішні канали, щоб уникнути підписки або плати за запис («обхід комісій»).',
        ...
        subsections: [
          {
            ...
            items: [
              ...
              'Альтернатива — оплата за запис: спеціалісти без активної підписки сплачують ₴20 за кожен підтверджений запис, оформлений через платформу.',
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          'Обход платформенных комиссий путём договорённостей со специалистами, найденными на MiyZapis, через внешние каналы во избежание подписки или платы за запись («обход комиссий»).',
        ...
        subsections: [
          {
            ...
            items: [
              ...
              'Альтернатива — оплата за запись: специалисты без активной подписки оплачивают ₴20 за каждую подтверждённую запись, оформленную через платформу.',
