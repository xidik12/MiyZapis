...
const mockServices: Service[] = [
  {
    ...
    nameUk: 'Індивідуальна психологічна консультація',
    nameRu: 'Индивидуальная психологическая консультация',
    description: 'One-on-one psychological counseling session for personal issues and mental health support.',
    descriptionUk: 'Індивідуальна психологічна консультація для особистих питань та підтримки психічного здоров\'я.',
    descriptionRu: 'Индивидуальная психологическая консультация по личным вопросам и поддержке психического здоровья.',
    category: 'Psychology',
    categoryUk: 'Психологія',
  ...
  },
  {
    ...
    nameUk: 'Сімейна терапія',
    nameRu: 'Семейная терапия',
    description: 'Professional family counseling to improve relationships and resolve conflicts.',
    descriptionUk: 'Професійне сімейне консультування для покращення стосунків та вирішення конфліктів.',
    descriptionRu: 'Профессиональное семейное консультирование для улучшения отношений и разрешения конфликтов.',
    category: 'Psychology',
    categoryUk: 'Психологія',
    categoryRu: 'Психология',
    price: 1500,
  ...
  },
  {
    id: '3',
    name: 'Group Therapy',
    nameUk: 'Групова терапія',
    nameRu: 'Групповая терапия',
    description: 'Group therapy sessions for shared experiences and peer support.',
    descriptionUk: 'Групові терапевтичні сесії для обміну досвідом та взаємної підтримки.',
    descriptionRu: 'Групповые терапевтические сессии для обмена опытом и взаимной поддержки.',
    category: 'Psychology',
    categoryUk: 'Психологія',
    categoryRu: 'Психология',
    price: 600,
  ...
  },
  {
    ...
    nameUk: 'Експрес-консультація',
    nameRu: 'Экспресс-консультация',
    description: 'Quick 30-minute consultation for urgent matters and brief guidance.',
    descriptionUk: 'Швидка 30-хвилинна консультація для термінових питань та короткої допомоги.',
    descriptionRu: 'Быстрая 30-минутная консультация для срочных вопросов и краткой помощи.',
    category: 'Psychology',
    categoryUk: 'Психологія',
    categoryRu: 'Психология',
    price: 500,
