      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
            {t('billing.subtitle') || 'Your full business toolkit — unlimited bookings, CRM, team & inventory. Pay with Telegram Stars.'}
          </p>
        </div>
      </div>
      ...
      {isSubscribed ? (
        ...
        <div className="rounded-2xl border border-primary-200 dark:border-primary-500/30 bg-primary-50/70 dark:bg-primary-900/10 p-4 sm:p-5">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
            {t('billing.trialNote') || 'Everyone starts with 2 months free. After that, a subscription keeps your full business toolkit.'}
          </p>
          {inTrial && (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-5 flex flex-col">
            ...
            <ul className="mt-4 space-y-2 text-sm text-gray-600 dark:text-gray-300 flex-1">
              ...
              <li className="flex gap-2"><CheckCircleIcon className="w-4 h-4 text-success-500 flex-shrink-0 mt-0.5" />{t('billing.featNoFee') || 'No commission on service revenue'}</li>
