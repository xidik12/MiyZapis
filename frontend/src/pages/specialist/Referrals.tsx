...
const SpecialistReferrals: React.FC = () => {
  ...
  const generateShareText = () => {
    if (!referralProgram) return '';
    return `Join MiyZapis with my referral code "${referralProgram.code}" and we both get ${referralProgram.refereePoints} loyalty points! 🎉 Find amazing specialists and book services at ${generateShareUrl()}`;
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Invite other specialists and customers to join the platform and earn loyalty points together
          </p>
        </div>
        ...
        {!referralProgram ? (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-8 border border-gray-200 dark:border-gray-700 mb-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Start earning points by inviting specialists and customers to join MiyZapis
            </p>
            <button
          ...
          <div className="bg-gradient-to-r from-primary-50 to-purple-50 dark:from-primary-900/20 dark:to-purple-900/20 rounded-xl shadow-sm p-8 border border-primary-200 dark:border-primary-800 mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              ...
              <a
                href={`mailto:?subject=Join MiyZapis as a Specialist&body=${encodeURIComponent(generateShareText())}`}
                className="flex flex-col items-center p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
              >
        ...
        {/* Benefits Section for Specialists */}
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start space-x-3">
              <div className="flex-shrink-0 h-8 w-8 bg-blue-100 dark:bg-blue-900/20 rounded-lg flex items-center justify-center">
                <UsersIcon className="h-5 w-5 text-blue-600 dark:text-blue-400" />
              </div>
              <div>
                <h4 className="font-medium text-gray-900 dark:text-white">Refer Other Specialists</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  Help grow the specialist community and earn points for successful referrals
                </p>
              </div>
            </div>
            
            <div className="flex items-start space-x-3">
              <div className="flex-shrink-0 h-8 w-8 bg-green-100 dark:bg-green-900/20 rounded-lg flex items-center justify-center">
                <GiftIcon className="h-5 w-5 text-green-600 dark:text-green-400" />
              </div>
              <div>
                <h4 className="font-medium text-gray-900 dark:text-white">Refer Customers</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  Bring new customers to the platform and expand your potential client base
                </p>
              </div>
            </div>
          </div>
        ...
        {userReferrals.length === 0 && referralProgram && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Start sharing your referral code to earn loyalty points and help grow the MiyZapis community!
            </p>
          </div>
        )}
      </div>
