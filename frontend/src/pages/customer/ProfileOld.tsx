                          ...
                          <div className="flex justify-between items-start mb-4">
                            ...
                            {isEditing && (
                              <div className="flex gap-2">
                                ...
                                <button className="p-2 text-error-600 hover:bg-error-50 rounded-xl transition-colors duration-200">
                                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              ...
                              <div className="flex items-center gap-4">
                                ...
                                <div>
                                  <div className="flex items-center gap-3 mb-1">
                                    ...
                                    {method.isDefault && (
                                      <span className="px-2 py-1 bg-primary-100 text-primary-700 rounded-xl text-xs font-medium">
                                        {language === 'uk' ? 'Основна' : language === 'ru' ? 'Основной' : 'Default'}
                                      </span>
                                    )}
                                    {method.isVerified && (
                                      <span className="px-2 py-1 bg-success-100 text-success-700 rounded-xl text-xs font-medium">
